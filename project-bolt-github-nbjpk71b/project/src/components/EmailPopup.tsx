...
import { X, Mail, User, Phone, Download, Shield, CheckCircle, ChevronDown, Search } from 'lucide-react';
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    {/* Country Dropdown with Search - positioned above the input */}
                    {showCountryDropdown && (
                      <div className="absolute bottom-full left-0 mb-2 w-full bg-white border border-gray-200 rounded-xl shadow-lg z-50 max-h-80 overflow-hidden">
                        <div className="p-3">
                          {/* Search Input */}
                          <div className="relative mb-3">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-dark-turquoise focus:border-dark-turquoise transition-all"
                            />
                          </div>
